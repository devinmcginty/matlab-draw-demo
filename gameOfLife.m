...
%		Replaced acorn with Gosper glider gun
%
...
% ----- CODE BEGINS ----- %
	...
	%	inGame - Generation 0 integer
		...
		while inGame < 1 | inGame > 6
			...
			fprintf('\t\t4. Queen bee shuttle (period 30 oscillator)\n');
			fprintf('\t\t5. Diehard (130 gen Methuselah)\n');
			fprintf('\t\t6. Gosper glider gun (eventually self-destructs)\n');
			fprintf('\t\t7. Random spore\n\n\t');
			inGame = input('> ');
		end
	end
